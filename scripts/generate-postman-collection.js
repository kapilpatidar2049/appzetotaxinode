...
const collection = {
  ...
  variable: [
    ...
    { key: "zoneId", value: "" },
    { key: "ownerMgmtFleetId", value: "" },
    { key: "ownerMgmtDriverId", value: "" },
    { key: "ownerMgmtOwnerId", value: "" },
    { key: "ownerMgmtDocId", value: "" },
    { key: "driverRatingId", value: "" },
    { key: "fleetDocumentUploadId", value: "" },
    { key: "driverDocumentUploadId", value: "" },
  ],
  item: [
    {
      name: "0. Root",
      ...
      item: [
        ...
        },
        {
          ...
          item: [
            ...
            req("Patch service location", "PATCH", "/api/v1/admin/service-locations/{{serviceLocationId}}", { tokenVar: "adminToken", body: "raw", rawBody: "{\"service_location_name\":\"Updated Location\",\"country\":\"{{countryId}}\",\"currency\":\"INR\",\"time_zone\":\"Asia/Kolkata\"}" }),
            req("Delete service location", "DELETE", "/api/v1/admin/service-locations/{{serviceLocationId}}", { tokenVar: "adminToken" }),
            req("List zones", "GET", "/api/v1/admin/zones", { tokenVar: "adminToken" }),
            req("Create zone", "POST", "/api/v1/admin/zones", { tokenVar: "adminToken", body: "raw", rawBody: "{\"languageFields\":{\"en\":\"India\"},\"coordinates\":\"[[[74.32202366298,20.929108563259],[78.89233616298,30.418825016773],[86.97827366298,20.975356214524],[77.13452366298,13.254452466582],[74.32202366298,20.929108563259]]]\",\"distance_price_percentage\":0,\"maximum_distance\":0,\"maximum_outstation_distance\":0,\"peak_zone_duration\":0,\"peak_zone_history_duration\":0,\"peak_zone_radius\":0,\"peak_zone_ride_count\":0,\"service_location_id\":\"{{serviceLocationId}}\",\"unit\":\"1\"}" }),
            req("Get zone", "GET", "/api/v1/admin/zones/{{zoneId}}", { tokenVar: "adminToken" }),
            req("Patch zone", "PATCH", "/api/v1/admin/zones/{{zoneId}}", { tokenVar: "adminToken", body: "raw", rawBody: "{\"active\":true}" }),
            req("Delete zone", "DELETE", "/api/v1/admin/zones/{{zoneId}}", { tokenVar: "adminToken" }),
          ],
        },
        {
          name: "Wallet admin actions",
          item: [
        ...
        },
        {
          ...
          item: [
            req("Owner management dashboard", "GET", "/api/v1/admin/owner-management/dashboard", { tokenVar: "adminToken" }),
            req("Manage owners list", "GET", "/api/v1/admin/owner-management/manage-owners", { tokenVar: "adminToken" }),
            req("Manage owner get", "GET", "/api/v1/admin/owner-management/manage-owners/{{ownerMgmtOwnerId}}", { tokenVar: "adminToken" }),
            req("Owner wallet list", "GET", "/api/v1/admin/owner-management/owner-wallet", { tokenVar: "adminToken" }),
            req("Owner wallet adjust", "POST", "/api/v1/admin/owner-management/owner-wallet/{{ownerMgmtOwnerId}}/adjust", { tokenVar: "adminToken", body: "raw", rawBody: "{\"amount\":100,\"remarks\":\"manual\"}" }),
            req("Fleet management list", "GET", "/api/v1/admin/owner-management/fleet-management", { tokenVar: "adminToken" }),
            req("Blocked fleet drivers", "GET", "/api/v1/admin/owner-management/blocked-fleet-drivers", { tokenVar: "adminToken" }),
            req("Fleet needed docs list", "GET", "/api/v1/admin/owner-management/fleet-needed-document", { tokenVar: "adminToken" }),
            req("Owner needed docs list", "GET", "/api/v1/admin/owner-management/owner-needed-document", { tokenVar: "adminToken" }),
            req("Driver needed docs list", "GET", "/api/v1/admin/owner-management/driver-needed-document", { tokenVar: "adminToken" }),
            req("Create driver needed doc", "POST", "/api/v1/admin/owner-management/driver-needed-document", { tokenVar: "adminToken", body: "raw", rawBody: "{\"name\":\"Driving License\",\"document_for\":\"fleet\",\"is_required\":true,\"active\":true}" }),
            req("Fleet uploads list", "GET", "/api/v1/admin/owner-management/fleet-documents", { tokenVar: "adminToken" }),
            req("Review fleet upload", "PATCH", "/api/v1/admin/owner-management/fleet-documents/{{fleetDocumentUploadId}}/review", { tokenVar: "adminToken", body: "raw", rawBody: "{\"status\":\"approved\"}" }),
            req("Driver uploads list", "GET", "/api/v1/admin/owner-management/driver-documents", { tokenVar: "adminToken" }),
            req("Review driver upload", "PATCH", "/api/v1/admin/owner-management/driver-documents/{{driverDocumentUploadId}}/review", { tokenVar: "adminToken", body: "raw", rawBody: "{\"status\":\"rejected\",\"rejected_reason\":\"Blur image\"}" }),
            req("Driver ratings list", "GET", "/api/v1/admin/owner-management/driver-ratings", { tokenVar: "adminToken" }),
            req("Driver ratings details", "GET", "/api/v1/admin/owner-management/driver-ratings/{{adminDriverId}}", { tokenVar: "adminToken" }),
          ],
        },
      ],
    },
